...
<html lang="en">
	<head>
		...
		<title>0910 Studio · Midnight Language</title>
	...
	<body>
		<div class="container">
				...
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="row about">
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								<p>
									Website para Midnight Language —
									<br/>
									Sello Digital de música electrónica
									<br/>
									Colombia, 2014
									<br/>
									<br/>
			...
			<div class="row page show">
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						<img class="lazy" data-src="05.jpg" src="" alt=""/>
					</div>
				</div>
			</div>
			<div class="row page show">
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						<img class="lazy" data-src="06.jpg" src="" alt=""/>
					</div>
				</div>
			</div>
			<div class="row page show" style="padding-bottom:5%;">
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						<img class="lazy" data-src="07.jpg" src="" alt=""/>
					</div>
				</div>
			</div>
