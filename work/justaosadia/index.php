...
<html lang="en">
	<head>
		...
		<title>0910 Studio · Justa Osadía</title>
	...
	<body>
		<div class="container">
				...
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="row about">
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								<p>
									Website F/W 2014 para Justa Osadía —
									<br/>
									Calzados y Carteras con cueros intervenidos
									<br/>
									Argentina, 2014
									<br/>
									<br/>
								</p>
								<p class="small">Ph. Nacho Ricci</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row page show" style="padding-top:5%;">
				<div class="container">
					<div class="col-sm-12 col-md-12 col-lg-12">
						<img class="lazy" data-src="000.jpg" src="" alt=""/>
					</div>
				</div>
			</div>
